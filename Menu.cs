...
namespace TravailPartie2
{
    ...
    public class MenuManager
    {
        ...
        private void InsererPeriodique()
        {
            Console.WriteLine("\nInsertion d’un périodique... (à implémenter)");
            Console.ReadKey();
        ...
        {
            Console.WriteLine("\nInsertion d’un livre... (à implémenter)");
            Console.ReadKey();
        }

        private void InsererBD()
        {
            Console.WriteLine("\nInsertion d’une BD... (à implémenter)");
            Console.ReadKey();
